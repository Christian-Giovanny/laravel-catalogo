...
@section('content')
    ...
    <section class="section-pad">
        <div class="container">
            ...
            @if ($error)
                <div
                    style="background:#fdf0f0;border:1px solid #f5c0c0;color:#7f1d1d;
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div style="margin-bottom:1rem;">
                            @if ($imagenPrincipal)
                                <img id="imgPrincipal" src="{{ $imagenPrincipal }}" alt="{{ $nombre }}"
                                    class="img-detail" style="transition:opacity .3s ease;"
                        ...
                        <div class="row g-2">
                            @foreach ([$img0, $img1, $img2] as $i => $img)
                                <div class="col-4">
                                    @if ($img)
                                        <img src="{{ $img }}" alt="{{ $nombre }} imagen {{ $i + 1 }}"
                                            class="img-thumb" onclick="cambiarImagen(this)"
                                    ...
                                    @else
                                        <div class="img-thumb d-flex align-items-center justify-content-center"
                                            ...
                                            <div class="text-center">
                                                <i class="bi bi-image"
                                                    style="font-size:1.5rem;color:var(--cafe-warm);display:block;"></i>
                    ...
                    <div class="col-lg-6">
                        <h2
                            style="font-size:clamp(1.8rem,3vw,2.5rem);font-weight:300;
                        ...
                        {{-- Stock --}}
                        <div class="mb-4 p-3"
                            style="background:var(--cafe-cream);border-radius:3px;
                     border-left:2px solid {{ $stock > 0 ? '#2d7a4f' : '#c0392b' }};">
                            <span
                                style="font-size:.7rem;font-weight:500;text-transform:uppercase;
                        ...
                        <form action="{{ route('carrito.agregar') }}" method="POST" class="mb-3">
                            ...
                            <input type="hidden" name="stock" value="{{ $stock ?? 999 }}">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <input type="number" name="cantidad" value="1" min="1" max="99"
                                    style="width:70px;border:1px solid rgba(107,63,42,.2);
                      border-radius:3px;padding:.5rem;font-family:'Poppins',sans-serif;
                      text-align:center;">
                                <button type="submit" class="btn-cafe" style="padding:.7rem 2rem;">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <a href="{{ route('carrito.index') }}" class="btn-outline-cafe">
            ...
            @else
                <div class="text-center py-5">
                    <i class="bi bi-cup"
                        style="font-size:3rem;color:var(--cafe-warm);display:block;margin-bottom:1rem;"></i>
